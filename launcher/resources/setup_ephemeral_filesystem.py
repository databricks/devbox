# Used to initialize the Runbot worker nodes.
import os, subprocess, stat, sys, json, resource, base64, random, shutil
from subprocess import check_call as call, check_output

ec2_instance_type = check_output(["ec2metadata", "--instance-type"]).strip()
# RAID ephemeral disks together for better IO performance
